      ...
      >
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 rounded-xl border border-black/10 py-3 font-semibold text-sm"
          >
            Cancel
          </button>
          <button
            type="submit"
            disabled={busy || !pin}
            className="flex-1 rounded-xl bg-foreground text-background py-3 font-semibold text-sm disabled:opacity-50"
          >
            Unlock
          </button>
        </div>
